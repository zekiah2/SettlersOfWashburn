...
//		lumberPanel = new ResPanel("Lumber");
		...
		vpPanel = new ResPanel("VP","File_Path");
		wheatPanel = new ResPanel("Wheat","File_Path");
		brickPanel = new ResPanel("Brick","File_Path");
		orePanel = new ResPanel("Ore","File_Path");
		woolPanel = new ResPanel("Wool","File_Path");
		lumberPanel = new ResPanel("Lumber","File_Path");
